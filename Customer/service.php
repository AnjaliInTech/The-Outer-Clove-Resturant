...
<body>
    ...
    <div class="facility">
        ...
        <button onclick="showBookingForm('Private Dining Room', 'facility')">Book Now</button>
    </div>
    ...
    <div class="facility">
        ...
        <button onclick="showBookingForm('Outdoor Terrace', 'facility')">Book Now</button>
    </div>
    ...
    <div class="facility">
        ...
        <button onclick="showBookingForm('Parking', 'parking')">Book Now</button>
    </div>
    ...
    <div class="facility">
        ...
        <p>Price: Free for restaurant customers</p>
        <button onclick="showBookingForm('seating capacities', 'facility')">Book Now</button>
    </div>
    ...
    <script>
        function showBookingForm(facilityName, bookingType) {
